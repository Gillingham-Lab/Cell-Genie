 ...
 */
final class Version20210326154723 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__experiment_type AS SELECT id, parent_id, name FROM experiment_type');
        $this->addSql('DROP TABLE experiment_type');
        $this->addSql('CREATE TABLE experiment_type (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, parent_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, description CLOB DEFAULT NULL, CONSTRAINT FK_97219684727ACA70 FOREIGN KEY (parent_id) REFERENCES experiment_type (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO experiment_type (id, parent_id, name) SELECT id, parent_id, name FROM __temp__experiment_type');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__experiment_type AS SELECT id, parent_id, name FROM experiment_type');
        $this->addSql('DROP TABLE experiment_type');
        $this->addSql('CREATE TABLE experiment_type (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, parent_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO experiment_type (id, parent_id, name) SELECT id, parent_id, name FROM __temp__experiment_type');
        $this->addSql('DROP TABLE __temp__experiment_type');
        $this->addSql('CREATE INDEX IDX_97219684727ACA70 ON experiment_type (parent_id)');
    }

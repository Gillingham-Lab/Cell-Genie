 ...
 */
final class Version20210327080130 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE culture_flask (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, rows SMALLINT NOT NULL, cols SMALLINT NOT NULL, comment CLOB DEFAULT NULL)');

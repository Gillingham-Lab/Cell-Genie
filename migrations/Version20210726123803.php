 ...
 */
final class Version20210726123803 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE culture_flask (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, vendor_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, cols SMALLINT NOT NULL, comment CLOB DEFAULT NULL COLLATE BINARY, rows SMALLINT DEFAULT 1 NOT NULL, CONSTRAINT FK_253A1758F603EE73 FOREIGN KEY (vendor_id) REFERENCES vendor (id) ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE culture_flask');
        $this->addSql('CREATE TABLE culture_flask (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, rows SMALLINT DEFAULT 1 NOT NULL, cols SMALLINT NOT NULL, comment CLOB DEFAULT NULL, vendor_id VARCHAR(255) DEFAULT NULL COLLATE BINARY)');

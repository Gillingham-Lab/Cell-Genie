 ...
 */
final class Version20210330174449 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__chemical AS SELECT id, vendor_id, long_name, short_name, smiles, labjournal FROM chemical');
        $this->addSql('DROP TABLE chemical');
        $this->addSql('CREATE TABLE chemical (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, vendor_id INTEGER DEFAULT NULL, long_name VARCHAR(255) NOT NULL COLLATE BINARY, short_name VARCHAR(10) NOT NULL COLLATE BINARY, smiles CLOB NOT NULL COLLATE BINARY, labjournal CLOB DEFAULT NULL COLLATE BINARY, vendor_pn VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_8ED9EDC3F603EE73 FOREIGN KEY (vendor_id) REFERENCES vendor (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO chemical (id, vendor_id, long_name, short_name, smiles, labjournal) SELECT id, vendor_id, long_name, short_name, smiles, labjournal FROM __temp__chemical');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__chemical AS SELECT id, vendor_id, long_name, short_name, smiles, labjournal FROM chemical');
        $this->addSql('DROP TABLE chemical');
        $this->addSql('CREATE TABLE chemical (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, long_name VARCHAR(255) NOT NULL, short_name VARCHAR(10) NOT NULL, smiles CLOB NOT NULL, labjournal CLOB DEFAULT NULL, vendor_id VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO chemical (id, vendor_id, long_name, short_name, smiles, labjournal) SELECT id, vendor_id, long_name, short_name, smiles, labjournal FROM __temp__chemical');
        $this->addSql('DROP TABLE __temp__chemical');
        $this->addSql('CREATE INDEX IDX_8ED9EDC3F603EE73 ON chemical (vendor_id)');
        $this->addSql('DROP INDEX IDX_253A1758F603EE73');

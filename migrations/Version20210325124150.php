 ...
 */
final class Version20210325124150 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__cell AS SELECT id, morphology_id, organism_id, tissue_id, parent_id, bought_by_id, name, age, culture_type, is_cancer, is_engineered, origin, vendor, vendor_id, price, origin_comment, acquired_on, medium, freezing, thawing, culture_conditions FROM cell');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_CB8787E2701EFC92');
        $this->addSql('DROP INDEX IDX_CB8787E2DEC6D6BA');
        $this->addSql('CREATE TEMPORARY TABLE __temp__cell AS SELECT id, parent_id, morphology_id, organism_id, tissue_id, bought_by_id, name, age, culture_type, is_cancer, is_engineered, origin, vendor, vendor_id, acquired_on, price, origin_comment, medium, freezing, thawing, culture_conditions FROM cell');
        $this->addSql('DROP TABLE cell');
        ...
        , name VARCHAR(255) NOT NULL, age VARCHAR(255) NOT NULL, culture_type VARCHAR(255) NOT NULL, is_cancer BOOLEAN NOT NULL, is_engineered BOOLEAN NOT NULL, origin VARCHAR(255) DEFAULT NULL, vendor VARCHAR(255) DEFAULT NULL, vendor_id VARCHAR(255) DEFAULT NULL, acquired_on DATETIME DEFAULT NULL, price NUMERIC(7, 2) DEFAULT NULL, origin_comment CLOB DEFAULT NULL, medium VARCHAR(255) DEFAULT NULL, freezing CLOB DEFAULT NULL, thawing CLOB DEFAULT NULL, culture_conditions CLOB DEFAULT NULL)');
        $this->addSql('INSERT INTO cell (id, parent_id, morphology_id, organism_id, tissue_id, bought_by_id, name, age, culture_type, is_cancer, is_engineered, origin, vendor, vendor_id, acquired_on, price, origin_comment, medium, freezing, thawing, culture_conditions) SELECT id, parent_id, morphology_id, organism_id, tissue_id, bought_by_id, name, age, culture_type, is_cancer, is_engineered, origin, vendor, vendor_id, acquired_on, price, origin_comment, medium, freezing, thawing, culture_conditions FROM __temp__cell');
        $this->addSql('DROP TABLE __temp__cell');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_CB8787E25E237E06 ON cell (name)');
        $this->addSql('CREATE INDEX IDX_CB8787E2727ACA70 ON cell (parent_id)');
        $this->addSql('CREATE INDEX IDX_CB8787E2B38B33AD ON cell (morphology_id)');

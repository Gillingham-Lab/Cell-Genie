 ...
 */
final class Version20210325105232 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__cell AS SELECT id, morphology_id, organism_id, tissue_id, parent_id, bought_by_id, name, age, culture_type, is_cancer, is_engineered, origin, vendor, vendor_id, aquired_on, price, origin_comment FROM cell');
        ...
        $this->addSql('INSERT INTO cell (id, morphology_id, organism_id, tissue_id, parent_id, bought_by_id, name, age, culture_type, is_cancer, is_engineered, origin, vendor, vendor_id, acquired_on, price, origin_comment) SELECT id, morphology_id, organism_id, tissue_id, parent_id, bought_by_id, name, age, culture_type, is_cancer, is_engineered, origin, vendor, vendor_id, aquired_on, price, origin_comment FROM __temp__cell');
    ...
    public function down(Schema $schema) : void
    {
        ...
        , name VARCHAR(255) NOT NULL, age VARCHAR(255) NOT NULL, culture_type VARCHAR(255) NOT NULL, is_cancer BOOLEAN NOT NULL, is_engineered BOOLEAN NOT NULL, origin VARCHAR(255) DEFAULT NULL, vendor VARCHAR(255) DEFAULT NULL, vendor_id VARCHAR(255) DEFAULT NULL, price NUMERIC(7, 2) DEFAULT NULL, origin_comment CLOB DEFAULT NULL, aquired_on DATETIME DEFAULT NULL)');
        $this->addSql('INSERT INTO cell (id, parent_id, morphology_id, organism_id, tissue_id, bought_by_id, name, age, culture_type, is_cancer, is_engineered, origin, vendor, vendor_id, aquired_on, price, origin_comment) SELECT id, parent_id, morphology_id, organism_id, tissue_id, bought_by_id, name, age, culture_type, is_cancer, is_engineered, origin, vendor, vendor_id, acquired_on, price, origin_comment FROM __temp__cell');
        $this->addSql('DROP TABLE __temp__cell');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_CB8787E25E237E06 ON cell (name)');
        $this->addSql('CREATE INDEX IDX_CB8787E2727ACA70 ON cell (parent_id)');
        $this->addSql('CREATE INDEX IDX_CB8787E2B38B33AD ON cell (morphology_id)');

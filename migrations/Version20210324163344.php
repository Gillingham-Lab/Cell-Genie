 ...
 */
final class Version20210324163344 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__box_entry AS SELECT id, box_row, box_col FROM box_entry');
        ...
        $this->addSql('INSERT INTO box_entry (id, box_row, box_col) SELECT id, box_row, box_col FROM __temp__box_entry');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__box_entry AS SELECT id, box_row, box_col FROM box_entry');
        $this->addSql('DROP TABLE box_entry');
        $this->addSql('CREATE TABLE box_entry (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, box_row INTEGER NOT NULL, box_col INTEGER NOT NULL, box_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO box_entry (id, box_row, box_col) SELECT id, box_row, box_col FROM __temp__box_entry');
        $this->addSql('DROP TABLE __temp__box_entry');

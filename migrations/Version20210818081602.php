...
final class Version20210818081602 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $table->addForeignKeyConstraint("antibody_host", ["host_organism_id"], ["id"], constraintName: "FK_5C97C6B11D6C21C8");
        $table->addForeignKeyConstraint("antibody_host", ["host_target_id"], ["id"], constraintName: "FK_5C97C6B1E10B57CB");

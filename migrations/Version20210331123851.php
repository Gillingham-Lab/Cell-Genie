 ...
 */
final class Version20210331123851 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE antibody_dilution (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, antibody_id INTEGER NOT NULL, experiment_type_id INTEGER DEFAULT NULL, experiment_id INTEGER DEFAULT NULL, dilution VARCHAR(15) NOT NULL COLLATE BINARY, CONSTRAINT FK_16A87BE351162764 FOREIGN KEY (antibody_id) REFERENCES antibody (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_16A87BE3EB0F4B39 FOREIGN KEY (experiment_type_id) REFERENCES experiment_type (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_16A87BE3FF444C8 FOREIGN KEY (experiment_id) REFERENCES experiment (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__cell AS SELECT id, morphology_id, organism_id, tissue_id, parent_id, bought_by_id, vendor_id, name, age, culture_type, is_cancer, is_engineered, origin, price, origin_comment, acquired_on, medium, freezing, thawing, culture_conditions, splitting, trypsin, vendor_pn, lysing, seeding, count_on_confluence, cell_number FROM cell');
        ...
        $this->addSql('INSERT INTO cell (id, morphology_id, organism_id, tissue_id, parent_id, bought_by_id, vendor_id, name, age, culture_type, is_cancer, is_engineered, origin, price, origin_comment, acquired_on, medium, freezing, thawing, culture_conditions, splitting, trypsin, vendor_pn, lysing, seeding, count_on_confluence, cell_number) SELECT id, morphology_id, organism_id, tissue_id, parent_id, bought_by_id, vendor_id, name, age, culture_type, is_cancer, is_engineered, origin, price, origin_comment, acquired_on, medium, freezing, thawing, culture_conditions, splitting, trypsin, vendor_pn, lysing, seeding, count_on_confluence, cell_number FROM __temp__cell');
        ...
        , title VARCHAR(255) NOT NULL COLLATE BINARY, body CLOB NOT NULL COLLATE BINARY, date DATETIME DEFAULT NULL, CONSTRAINT FK_B6BD307FF675F31B FOREIGN KEY (author_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');

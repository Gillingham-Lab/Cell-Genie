 ...
 */
final class Version20210330171919 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE chemical (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, vendor_id VARCHAR(255) DEFAULT NULL COLLATE BINARY, long_name VARCHAR(255) NOT NULL COLLATE BINARY, short_name VARCHAR(10) NOT NULL COLLATE BINARY, smiles CLOB NOT NULL COLLATE BINARY, labjournal CLOB DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_8ED9EDC3F603EE73 FOREIGN KEY (vendor_id) REFERENCES vendor (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__experiment AS SELECT id, owner_id, experiment_type_id, wellplate_id, name FROM experiment');
        ...
        , experiment_type_id INTEGER NOT NULL, wellplate_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, lysing CLOB DEFAULT NULL, seeding CLOB DEFAULT NULL, CONSTRAINT FK_136F58B27E3C61F9 FOREIGN KEY (owner_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_136F58B2EB0F4B39 FOREIGN KEY (experiment_type_id) REFERENCES experiment_type (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_136F58B2C14C34C2 FOREIGN KEY (wellplate_id) REFERENCES culture_flask (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO experiment (id, owner_id, experiment_type_id, wellplate_id, name) SELECT id, owner_id, experiment_type_id, wellplate_id, name FROM __temp__experiment');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__chemical AS SELECT id, vendor_id, long_name, short_name, smiles, labjournal FROM chemical');
        $this->addSql('DROP TABLE chemical');
        $this->addSql('CREATE TABLE chemical (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, vendor_id VARCHAR(255) DEFAULT NULL, long_name VARCHAR(255) NOT NULL, short_name VARCHAR(10) NOT NULL, smiles CLOB NOT NULL, labjournal CLOB DEFAULT NULL)');
        $this->addSql('INSERT INTO chemical (id, vendor_id, long_name, short_name, smiles, labjournal) SELECT id, vendor_id, long_name, short_name, smiles, labjournal FROM __temp__chemical');
        $this->addSql('DROP TABLE __temp__chemical');
        $this->addSql('CREATE INDEX IDX_8ED9EDC3F603EE73 ON chemical (vendor_id)');
        $this->addSql('DROP INDEX IDX_253A1758F603EE73');
        ...
        $this->addSql('DROP TABLE experiment');
        $this->addSql('CREATE TABLE experiment (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, owner_id BLOB NOT NULL --(DC2Type:ulid)
        , experiment_type_id INTEGER NOT NULL, wellplate_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO experiment (id, owner_id, experiment_type_id, wellplate_id, name) SELECT id, owner_id, experiment_type_id, wellplate_id, name FROM __temp__experiment');
        $this->addSql('DROP TABLE __temp__experiment');
        $this->addSql('CREATE INDEX IDX_136F58B27E3C61F9 ON experiment (owner_id)');
        $this->addSql('CREATE INDEX IDX_136F58B2EB0F4B39 ON experiment (experiment_type_id)');

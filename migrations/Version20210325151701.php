 ...
 */
final class Version20210325151701 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD COLUMN is_admin BOOLEAN DEFAULT NULL');
        $this->addSql('ALTER TABLE user ADD COLUMN is_active BOOLEAN DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_E2BD6163D8177B3F ON cell_aliquote (box_id)');
        $this->addSql('CREATE INDEX IDX_E2BD6163CB39D93A ON cell_aliquote (cell_id)');
        $this->addSql('DROP INDEX UNIQ_8D93D649DBC463C4');

...
final class Version20210824072842 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $table->addForeignKeyConstraint("antibody", ["antibody_id"], ["id"], constraintName: "FK_5B63125D51162764");
        $table->addForeignKeyConstraint("file", ["file_id"], ["id"], constraintName: "FK_5B63125D93CB796C");
    }

...
final class Version20210825145903 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $table->addForeignKeyConstraint("cell", ["cell_id"], ["id"], options: ["onDelete" => "cascade"], constraintName: "FK_3F545FB6CB39D93A");
        $table->addForeignKeyConstraint("file", ["file_id"], ["id"], constraintName: "FK_3F545FB693CB796C");
    }

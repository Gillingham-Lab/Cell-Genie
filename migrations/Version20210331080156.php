 ...
 */
final class Version20210331080156 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__antibody AS SELECT id, vendor_id, short_name, long_name, vendor_pn FROM antibody');
        $this->addSql('DROP TABLE antibody');
        $this->addSql('CREATE TABLE antibody (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, vendor_id INTEGER DEFAULT NULL, short_name VARCHAR(255) NOT NULL COLLATE BINARY, long_name VARCHAR(255) NOT NULL COLLATE BINARY, vendor_pn VARCHAR(50) DEFAULT NULL COLLATE BINARY, detection VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_5C97C6B1F603EE73 FOREIGN KEY (vendor_id) REFERENCES vendor (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO antibody (id, vendor_id, short_name, long_name, vendor_pn) SELECT id, vendor_id, short_name, long_name, vendor_pn FROM __temp__antibody');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__antibody AS SELECT id, vendor_id, short_name, long_name, vendor_pn FROM antibody');
        $this->addSql('DROP TABLE antibody');
        $this->addSql('CREATE TABLE antibody (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, vendor_id INTEGER DEFAULT NULL, short_name VARCHAR(255) NOT NULL, long_name VARCHAR(255) NOT NULL, vendor_pn VARCHAR(50) DEFAULT NULL)');
        $this->addSql('INSERT INTO antibody (id, vendor_id, short_name, long_name, vendor_pn) SELECT id, vendor_id, short_name, long_name, vendor_pn FROM __temp__antibody');
        $this->addSql('DROP TABLE __temp__antibody');
        $this->addSql('CREATE INDEX IDX_5C97C6B1F603EE73 ON antibody (vendor_id)');
        $this->addSql('DROP INDEX IDX_C0A299815F76A57');

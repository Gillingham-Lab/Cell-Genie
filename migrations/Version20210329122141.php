 ...
 */
final class Version20210329122141 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__cell AS SELECT id, morphology_id, organism_id, tissue_id, parent_id, bought_by_id, vendor_id, name, age, culture_type, is_cancer, is_engineered, origin, price, origin_comment, acquired_on, medium, freezing, thawing, culture_conditions, splitting, trypsin, vendor_pn FROM cell');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_CB8787E2F603EE73');
        $this->addSql('DROP INDEX IDX_CB8787E2DEC6D6BA');
        $this->addSql('CREATE TEMPORARY TABLE __temp__cell AS SELECT id, parent_id, morphology_id, organism_id, tissue_id, vendor_id, bought_by_id, name, age, culture_type, is_cancer, is_engineered, origin, vendor_pn, acquired_on, price, origin_comment, medium, freezing, thawing, culture_conditions, splitting, trypsin FROM cell');
        $this->addSql('DROP TABLE cell');
        ...
        $this->addSql('INSERT INTO cell (id, parent_id, morphology_id, organism_id, tissue_id, vendor_id, bought_by_id, name, age, culture_type, is_cancer, is_engineered, origin, vendor_pn, acquired_on, price, origin_comment, medium, freezing, thawing, culture_conditions, splitting, trypsin) SELECT id, parent_id, morphology_id, organism_id, tissue_id, vendor_id, bought_by_id, name, age, culture_type, is_cancer, is_engineered, origin, vendor_pn, acquired_on, price, origin_comment, medium, freezing, thawing, culture_conditions, splitting, trypsin FROM __temp__cell');
        $this->addSql('DROP TABLE __temp__cell');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_CB8787E25E237E06 ON cell (name)');
        $this->addSql('CREATE INDEX IDX_CB8787E2727ACA70 ON cell (parent_id)');
        $this->addSql('CREATE INDEX IDX_CB8787E2B38B33AD ON cell (morphology_id)');

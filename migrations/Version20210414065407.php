 ...
 */
final class Version20210414065407 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__cell_aliquote AS SELECT id, aliquoted_by_id, cell_id, box_id, aliquoted_on, vial_color, vials, passage, cell_count, mycoplasma, typing, history, cryo_medium FROM cell_aliquote');
        ...
        , cell_id INTEGER NOT NULL, box_id INTEGER DEFAULT NULL, aliquoted_on DATETIME NOT NULL, vial_color VARCHAR(30) NOT NULL COLLATE BINARY, vials INTEGER NOT NULL, passage INTEGER NOT NULL, cell_count INTEGER NOT NULL, mycoplasma CLOB DEFAULT NULL COLLATE BINARY, typing CLOB DEFAULT NULL COLLATE BINARY, history CLOB DEFAULT NULL COLLATE BINARY, cryo_medium VARCHAR(255) DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_E2BD6163C88E0642 FOREIGN KEY (aliquoted_by_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_E2BD6163D8177B3F FOREIGN KEY (box_id) REFERENCES box (id) ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_E2BD6163CB39D93A FOREIGN KEY (cell_id) REFERENCES cell (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO cell_aliquote (id, aliquoted_by_id, cell_id, box_id, aliquoted_on, vial_color, vials, passage, cell_count, mycoplasma, typing, history, cryo_medium) SELECT id, aliquoted_by_id, cell_id, box_id, aliquoted_on, vial_color, vials, passage, cell_count, mycoplasma, typing, history, cryo_medium FROM __temp__cell_aliquote');

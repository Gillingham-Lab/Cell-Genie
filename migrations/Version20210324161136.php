 ...
 */
final class Version20210324161136 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__cell AS SELECT id, morphology_id, organism_id, tissue_id, parent_id, name, age, culture_type, is_cancer, is_engineered FROM cell');
        ...
        $this->addSql('INSERT INTO cell (id, morphology_id, organism_id, tissue_id, parent_id, name, age, culture_type, is_cancer, is_engineered) SELECT id, morphology_id, organism_id, tissue_id, parent_id, name, age, culture_type, is_cancer, is_engineered FROM __temp__cell');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__cell_aliquote AS SELECT id, aliquoted_by_id, box_id, aliquoted_on, vial_color, vials, passage, cell_count, mycoplasma, typing, history FROM cell_aliquote');
        ...
        $this->addSql('INSERT INTO cell_aliquote (id, aliquoted_by_id, box_id, aliquoted_on, vial_color, vials, passage, cell_count, mycoplasma, typing, history) SELECT id, aliquoted_by_id, box_id, aliquoted_on, vial_color, vials, passage, cell_count, mycoplasma, typing, history FROM __temp__cell_aliquote');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE cell');
        $this->addSql('CREATE TABLE cell (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, parent_id INTEGER DEFAULT NULL, morphology_id INTEGER DEFAULT NULL, organism_id INTEGER DEFAULT NULL, tissue_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL, age VARCHAR(255) NOT NULL, culture_type VARCHAR(255) NOT NULL, is_cancer BOOLEAN NOT NULL, is_engineered BOOLEAN NOT NULL)');

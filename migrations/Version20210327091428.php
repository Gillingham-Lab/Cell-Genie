 ...
 */
final class Version20210327091428 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE culture_flask (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, cols SMALLINT NOT NULL, comment CLOB DEFAULT NULL COLLATE BINARY, rows SMALLINT DEFAULT 1 NOT NULL)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__experiment_type AS SELECT id, parent_id, name, description, lysing, seeding FROM experiment_type');
        ...
        $this->addSql('INSERT INTO experiment_type (id, parent_id, name, description, lysing, seeding) SELECT id, parent_id, name, description, lysing, seeding FROM __temp__experiment_type');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__culture_flask AS SELECT id, name, rows, cols, comment FROM culture_flask');
        $this->addSql('DROP TABLE culture_flask');
        $this->addSql('CREATE TABLE culture_flask (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, cols SMALLINT NOT NULL, comment CLOB DEFAULT NULL, rows SMALLINT NOT NULL)');
        $this->addSql('INSERT INTO culture_flask (id, name, rows, cols, comment) SELECT id, name, rows, cols, comment FROM __temp__culture_flask');
        $this->addSql('DROP TABLE __temp__culture_flask');
        $this->addSql('DROP INDEX IDX_136F58B27E3C61F9');
        $this->addSql('DROP INDEX IDX_136F58B2EB0F4B39');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__experiment_type AS SELECT id, parent_id, name, description, lysing, seeding FROM experiment_type');
        $this->addSql('DROP TABLE experiment_type');
        $this->addSql('CREATE TABLE experiment_type (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, parent_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL, description CLOB DEFAULT NULL, lysing CLOB DEFAULT NULL, seeding CLOB DEFAULT NULL, wellplate VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO experiment_type (id, parent_id, name, description, lysing, seeding) SELECT id, parent_id, name, description, lysing, seeding FROM __temp__experiment_type');
        $this->addSql('DROP TABLE __temp__experiment_type');
        $this->addSql('CREATE INDEX IDX_97219684727ACA70 ON experiment_type (parent_id)');
    }

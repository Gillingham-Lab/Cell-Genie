 ...
 */
final class Version20210331095037 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__antibody AS SELECT id, vendor_id, short_name, long_name, vendor_pn, detection FROM antibody');
        $this->addSql('DROP TABLE antibody');
        $this->addSql('CREATE TABLE antibody (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, vendor_id INTEGER DEFAULT NULL, short_name VARCHAR(255) NOT NULL COLLATE BINARY, long_name VARCHAR(255) NOT NULL COLLATE BINARY, vendor_pn VARCHAR(50) DEFAULT NULL COLLATE BINARY, detection VARCHAR(255) DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_5C97C6B1F603EE73 FOREIGN KEY (vendor_id) REFERENCES vendor (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO antibody (id, vendor_id, short_name, long_name, vendor_pn, detection) SELECT id, vendor_id, short_name, long_name, vendor_pn, detection FROM __temp__antibody');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__cell AS SELECT id, morphology_id, organism_id, tissue_id, parent_id, bought_by_id, vendor_id, name, age, culture_type, is_cancer, is_engineered, origin, price, origin_comment, acquired_on, medium, freezing, thawing, culture_conditions, splitting, trypsin, vendor_pn, lysing, seeding, count_on_confluence FROM cell');
        ...
        , vendor_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, age VARCHAR(255) NOT NULL COLLATE BINARY, culture_type VARCHAR(255) NOT NULL COLLATE BINARY, is_cancer BOOLEAN NOT NULL, is_engineered BOOLEAN NOT NULL, origin VARCHAR(255) DEFAULT NULL COLLATE BINARY, price NUMERIC(7, 2) DEFAULT NULL, origin_comment CLOB DEFAULT NULL COLLATE BINARY, acquired_on DATETIME DEFAULT NULL, medium VARCHAR(255) DEFAULT NULL COLLATE BINARY, freezing CLOB DEFAULT NULL COLLATE BINARY, thawing CLOB DEFAULT NULL COLLATE BINARY, culture_conditions CLOB DEFAULT NULL COLLATE BINARY, splitting CLOB DEFAULT NULL COLLATE BINARY, trypsin VARCHAR(255) DEFAULT NULL COLLATE BINARY, vendor_pn VARCHAR(255) DEFAULT NULL COLLATE BINARY, lysing CLOB DEFAULT NULL COLLATE BINARY, seeding CLOB DEFAULT NULL COLLATE BINARY, count_on_confluence INTEGER DEFAULT NULL, CONSTRAINT FK_CB8787E2727ACA70 FOREIGN KEY (parent_id) REFERENCES cell (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_CB8787E2B38B33AD FOREIGN KEY (morphology_id) REFERENCES morphology (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_CB8787E264180A36 FOREIGN KEY (organism_id) REFERENCES organism (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_CB8787E2701EFC92 FOREIGN KEY (tissue_id) REFERENCES tissue (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_CB8787E2F603EE73 FOREIGN KEY (vendor_id) REFERENCES vendor (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_CB8787E2DEC6D6BA FOREIGN KEY (bought_by_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO cell (id, morphology_id, organism_id, tissue_id, parent_id, bought_by_id, vendor_id, name, age, culture_type, is_cancer, is_engineered, origin, price, origin_comment, acquired_on, medium, freezing, thawing, culture_conditions, splitting, trypsin, vendor_pn, lysing, seeding, count_on_confluence) SELECT id, morphology_id, organism_id, tissue_id, parent_id, bought_by_id, vendor_id, name, age, culture_type, is_cancer, is_engineered, origin, price, origin_comment, acquired_on, medium, freezing, thawing, culture_conditions, splitting, trypsin, vendor_pn, lysing, seeding, count_on_confluence FROM __temp__cell');
        ...
        $this->addSql('CREATE TABLE chemical (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, vendor_id INTEGER DEFAULT NULL, long_name VARCHAR(255) NOT NULL COLLATE BINARY, short_name VARCHAR(10) NOT NULL COLLATE BINARY, smiles CLOB NOT NULL COLLATE BINARY, labjournal CLOB DEFAULT NULL COLLATE BINARY, vendor_pn VARCHAR(255) DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_8ED9EDC3F603EE73 FOREIGN KEY (vendor_id) REFERENCES vendor (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__culture_flask AS SELECT id, vendor_id, name, cols, comment, rows FROM culture_flask');
        $this->addSql('DROP TABLE culture_flask');
        $this->addSql('CREATE TABLE culture_flask (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, vendor_id VARCHAR(255) DEFAULT NULL COLLATE BINARY, name VARCHAR(255) NOT NULL COLLATE BINARY, cols SMALLINT NOT NULL, comment CLOB DEFAULT NULL COLLATE BINARY, rows SMALLINT DEFAULT 1 NOT NULL, CONSTRAINT FK_253A1758F603EE73 FOREIGN KEY (vendor_id) REFERENCES vendor (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO culture_flask (id, vendor_id, name, cols, comment, rows) SELECT id, vendor_id, name, cols, comment, rows FROM __temp__culture_flask');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__experiment AS SELECT id, owner_id, experiment_type_id, wellplate_id, name, lysing, seeding FROM experiment');
        ...
        , experiment_type_id INTEGER NOT NULL, wellplate_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, lysing CLOB DEFAULT NULL COLLATE BINARY, seeding CLOB DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_136F58B27E3C61F9 FOREIGN KEY (owner_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_136F58B2EB0F4B39 FOREIGN KEY (experiment_type_id) REFERENCES experiment_type (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_136F58B2C14C34C2 FOREIGN KEY (wellplate_id) REFERENCES culture_flask (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO experiment (id, owner_id, experiment_type_id, wellplate_id, name, lysing, seeding) SELECT id, owner_id, experiment_type_id, wellplate_id, name, lysing, seeding FROM __temp__experiment');
        ...
        $this->addSql('ALTER TABLE vendor ADD COLUMN comment CLOB DEFAULT NULL');
        $this->addSql('ALTER TABLE vendor ADD COLUMN is_preferred BOOLEAN DEFAULT \'0\' NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__antibody AS SELECT id, vendor_id, short_name, long_name, vendor_pn, detection FROM antibody');
        $this->addSql('DROP TABLE antibody');
        $this->addSql('CREATE TABLE antibody (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, vendor_id INTEGER DEFAULT NULL, short_name VARCHAR(255) NOT NULL, long_name VARCHAR(255) NOT NULL, vendor_pn VARCHAR(50) DEFAULT NULL, detection VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO antibody (id, vendor_id, short_name, long_name, vendor_pn, detection) SELECT id, vendor_id, short_name, long_name, vendor_pn, detection FROM __temp__antibody');
        $this->addSql('DROP TABLE __temp__antibody');
        $this->addSql('CREATE INDEX IDX_5C97C6B1F603EE73 ON antibody (vendor_id)');
        $this->addSql('DROP INDEX IDX_C0A299815F76A57');
        ...
        $this->addSql('DROP INDEX IDX_CB8787E2F603EE73');
        $this->addSql('DROP INDEX IDX_CB8787E2DEC6D6BA');
        $this->addSql('CREATE TEMPORARY TABLE __temp__cell AS SELECT id, parent_id, morphology_id, organism_id, tissue_id, vendor_id, bought_by_id, name, age, culture_type, is_cancer, is_engineered, origin, vendor_pn, acquired_on, price, origin_comment, medium, freezing, thawing, culture_conditions, splitting, trypsin, lysing, seeding, count_on_confluence FROM cell');
        $this->addSql('DROP TABLE cell');
        ...
        $this->addSql('INSERT INTO cell (id, parent_id, morphology_id, organism_id, tissue_id, vendor_id, bought_by_id, name, age, culture_type, is_cancer, is_engineered, origin, vendor_pn, acquired_on, price, origin_comment, medium, freezing, thawing, culture_conditions, splitting, trypsin, lysing, seeding, count_on_confluence) SELECT id, parent_id, morphology_id, organism_id, tissue_id, vendor_id, bought_by_id, name, age, culture_type, is_cancer, is_engineered, origin, vendor_pn, acquired_on, price, origin_comment, medium, freezing, thawing, culture_conditions, splitting, trypsin, lysing, seeding, count_on_confluence FROM __temp__cell');
        $this->addSql('DROP TABLE __temp__cell');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_CB8787E25E237E06 ON cell (name)');
        $this->addSql('CREATE INDEX IDX_CB8787E2727ACA70 ON cell (parent_id)');
        $this->addSql('CREATE INDEX IDX_CB8787E2B38B33AD ON cell (morphology_id)');
        ...
        $this->addSql('DROP TABLE culture_flask');
        $this->addSql('CREATE TABLE culture_flask (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, vendor_id VARCHAR(255) DEFAULT NULL, name VARCHAR(255) NOT NULL, rows SMALLINT DEFAULT 1 NOT NULL, cols SMALLINT NOT NULL, comment CLOB DEFAULT NULL)');
        ...
        $this->addSql('DROP TABLE experiment');
        $this->addSql('CREATE TABLE experiment (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, owner_id BLOB NOT NULL --(DC2Type:ulid)
        , experiment_type_id INTEGER NOT NULL, wellplate_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL, lysing CLOB DEFAULT NULL, seeding CLOB DEFAULT NULL)');
        $this->addSql('INSERT INTO experiment (id, owner_id, experiment_type_id, wellplate_id, name, lysing, seeding) SELECT id, owner_id, experiment_type_id, wellplate_id, name, lysing, seeding FROM __temp__experiment');
        $this->addSql('DROP TABLE __temp__experiment');
        $this->addSql('CREATE INDEX IDX_136F58B27E3C61F9 ON experiment (owner_id)');
        $this->addSql('CREATE INDEX IDX_136F58B2EB0F4B39 ON experiment (experiment_type_id)');
        ...
        $this->addSql('CREATE INDEX IDX_97219684727ACA70 ON experiment_type (parent_id)');
        $this->addSql('CREATE INDEX IDX_97219684C14C34C2 ON experiment_type (wellplate_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__vendor AS SELECT id, name, catalog_url, has_free_shipping, has_discount FROM vendor');
        ...
        $this->addSql('INSERT INTO vendor (id, name, catalog_url, has_free_shipping, has_discount) SELECT id, name, catalog_url, has_free_shipping, has_discount FROM __temp__vendor');
        $this->addSql('DROP TABLE __temp__vendor');
    }
}
